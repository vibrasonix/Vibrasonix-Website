                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 offset-lg-1">
                                        <div class="intro-project-right">
                                            ...
                                            <p class="intro-project-description">Vin tries to reflect Diesel’s vision
                                                and combines the universe of the rock of
                                                the 80’s with a clear and
                                                essential design to be more confident with
                                                its customers who need strong
                                                symbols through which express
                                                themselves</p>
                                            ...
                                            <a target="_blank" href="https://www.behance.net/gallery/66818513/Maybe"
                                                ...
                                                <span class="inner-visit d-flex align-items-center">
                                                    ...
                                                    <span class="icon">
                                                        <svg viewBox="0 0 40 40">
                                                            <polyline class="path"
                                                                points="14.6 17.45 20 22.85 25.4 17.45"></polyline>
                                                        </svg>
                                                    </span>
                                                </span>
                                            </a>
                        ...
                        <div class="section-margin p-relative">
                            <div class="img-box-parallax" data-dsn-grid="move-up">
                                <img class="has-bigger-scale"
                                    ...
                                    data-dsn-srcset="assets/img/project/project1/2.jpg 1800w,assets/img/project/project1/2-sm.jpg 768w" alt="">
                                <div class="cap">
                        ...
                        <div class="section-margin has-popup over-hidden p-relative">
                            <div class="container">
                                <div class="d-grid grid-md-3  over-hidden">
                                    ...
                                    <a href="assets/img/project/project1/5.jpg"
                                        class="p-relative over-hidden h-v-60 d-flex">
                                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                        ...
                        <div class="container-fluid no-padding section-margin p-relative">
                            <div class="img-box-parallax" data-dsn-grid="move-up">
                                <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                    ...
                                    data-dsn-srcset="assets/img/project/project1/6.jpg 1800w,assets/img/project/project1/6-sm.jpg 768w" alt=""
                                    ...
                                    <div class="col-lg-6  dsn-z-index-2 pr-0 mb-lg-section">
                                        <div class="box-im h-100 ">
                                            <div class="img-container h-100" data-dsn-grid="move-up">
                                                <img class="cover-bg-img " data-dsn-speed="10%"
                                                    src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                                    ...
                                    <div class="col-lg-6 pl-0 mt-lg-section">
                                        <div class="box-info h-100 box-padding background-section ">
                                            <div class="box-info-inner">
                                                ...
                                                <div class="vertical-title mb-30">
                                                    <h2 class="dsn-text">Maybe speaker</h2>
                                                </div>
                                                <p>A system that young people around the world with a club culture and
                                                    techno
                                                    enthusiasts feel identified. We generated a simple logo that is the
                                                    basis for
                                                    generating a geometric and liquid system. </p>
                                                <p class="mt-15">A system that young people around the world with a club
                                                    culture and
                                                    techno
                                                    ...
                                                    basis for
                                                    generating a geometric and liquid system. </p>
                                                <a href="#0" class="mt-30 dsn-button">
                        ...
                        <div
                            ...
                            <a href="project2.html" class="effect-ajax border-top border-bottom" data-dsn-ajax="next">
                                <h2 class="title section-padding p-relative ">
                                    ...
                                    <span class="p-absolute section-padding d-none top-0 w-100 h-100 left-0">Yaren
                                        collection</span>
                                </h2>
                            </a>
                            <div class="case">
